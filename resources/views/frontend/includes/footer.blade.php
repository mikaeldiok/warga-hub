  ...
  <div class="container">
    <div class="row mb-5">
      <div class="col-md-6 col-lg-4">
        ...
        <p><a href="#" class="link-underline text-warning">Read  More</a></p>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="block-23">
          <h3 class="heading-section">Get Connected</h3>
            <ul>
              <li><span class="icon icon-map-marker text-warning"></span><span class="text">203 Fake St. Mountain View, San Francisco, California, USA</span></li>
              <li><a href="#" class="text-warning"><span class="icon icon-phone text-warning"></span><span class="text">+2 392 3929 210</span></a></li>
              <li><a href="#" class="text-warning"><span class="icon icon-envelope text-warning"></span><span class="text">info@yourdomain.com</span></a></li>
            </ul>
          </div>
      </div>
