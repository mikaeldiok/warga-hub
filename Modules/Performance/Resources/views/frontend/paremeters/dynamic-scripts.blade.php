@php
    $status = \Modules\Performance\Services\ParameterService::prepareStatusFilter();
    \Log::debug($status);
...
<script>
    ...
    $(document).ready(function(){
        $(document).on('click', 'button.choose-parameter', function(e){
            var ele = $(this);  
            var fireAjax = false;
