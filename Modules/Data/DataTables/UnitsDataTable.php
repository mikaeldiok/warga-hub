...
class UnitsDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('photo')->title(__("data::units.photo")),
            Column::make('name')->title(__("data::units.name")),
            Column::make('unit_id')->title(__("data::units.unit_id")),
            Column::make('available')->title(__("data::units.available")),
