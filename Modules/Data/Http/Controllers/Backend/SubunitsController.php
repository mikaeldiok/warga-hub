...
use Modules\Data\DataTables\SubunitsDataTable;
use Modules\Data\Http\Requests\Backend\SubunitsRequest;
...
class SubunitsController extends Controller
{
    ...
    public function __construct(SubunitService $subunitService)
    {
        ...
        $this->module_model = "Modules\Data\Entities\Subunit";
     ...
     * @return Response
     */
    public function index(SubunitsDataTable $dataTable)
    {
    ...
    public function create()
    {
        ...
        $options = $this->subunitService->create()->data;
     ...
     * @return Response
     */
    public function store(SubunitsRequest $request)
    {
        $module_title = $this->module_title;
        $module_name = $this->module_name;
        $module_path = $this->module_path;
        ...
        $subunits = $this->subunitService->store($request);

        $$module_name_singular = $subunits->data;
    ...
    public function show($id)
    {
        ...
        $subunits = $this->subunitService->show($id);
    ...
    public function edit($id)
    {
        ...
        $subunits = $this->subunitService->edit($id);

        $$module_name_singular = $subunits->data;

        $options = $this->subunitService->prepareOptions();
     ...
     * @return Response
     */
    public function update(SubunitsRequest $request, $id)
    {
        $module_title = $this->module_title;
        $module_name = $this->module_name;
        $module_path = $this->module_path;
        ...
        $subunits = $this->subunitService->update($request,$id);
    ...
    public function destroy($id)
    {
        ...
        $subunits = $this->subunitService->destroy($id);
    ...
    public function purge($id)
    {
        ...
        $subunits = $this->subunitService->purge($id);
    ...
    public function trashed()
    {
        ...
        $subunits = $this->subunitService->trashed();

        $$module_name = $subunits->data;
    ...
    public function restore($id)
    {
        ...
        $subunits = $this->subunitService->restore($id);
    ...
    public function import(Request $request)
    {
        ...
        $subunits = $this->subunitService->import($request);

        $import = $subunits->data;
    ...
    /**
     * FOr getting subunit data via ajax
     *
     * @return Response
     */
    public function get_subunit(Request $request)
    {
        ...
        $response = $this->subunitService->get_subunit($request);
