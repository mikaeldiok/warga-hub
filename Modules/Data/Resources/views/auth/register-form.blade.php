...
<div class="row">
    <div class="col-md-5">
        <div class="form-group">
            ...
            $field_data_id = 'unit_type';
            $field_lable = __("data::$module_name.$field_name");
            $field_placeholder = __("Select an option");
            $required = "required";
            $select_options = $unit_types;
            ?>
            {{ html()->label($field_lable, $field_name) }} {!! fielf_required($required) !!}
...
<div class="row">
    <div class="col-md-8">
        <div class="form-group">
            <?php
            $field_name = 'unit_bank_name';
            $field_data_id = 'unit_bank_name';
            $field_lable = __("data::$module_name.$field_name");
            $field_placeholder = __("Select an option");
            $required = "required";
