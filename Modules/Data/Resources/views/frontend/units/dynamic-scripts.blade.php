@php
    $status = \Modules\Data\Services\UnitService::prepareStatusFilter();
    \Log::debug($status);
...
<script>
    ...
    $(document).ready(function(){
        $(document).on('click', 'button.choose-unit', function(e){
            var ele = $(this);  
            var fireAjax = false;
