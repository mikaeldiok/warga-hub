...
use Modules\School\DataTables\CoresDataTable;
use Modules\School\Http\Requests\Backend\CoresRequest;
...
class CoresController extends Controller
{
    ...
    {
        // Page Title
        $this->module_title = trans('menu.school.cores');
        ...
        $this->module_model = "Modules\School\Entities\Core";
