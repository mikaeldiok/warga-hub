...
class Core extends UserModel implements HasMedia
{
    ...
    protected $table = "school_cores";

    protected static $logName = 'school_cores';
    ...
    public static function getRawData(String $core_code){
        $core_data = self::where('school_core_code', $core_code)->first();
        $raw_data= explode(",",$core_data->school_core_value);
